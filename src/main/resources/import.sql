...
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (1, 'PRODUCT-A00001', 'Madera de Cedro', 'Madera de Cedro', 1000, 1000, 1000, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (2, 'PRODUCT-A00002', 'Madera de Pino', 'Madera de Pino', 500, 500, 500, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (3, 'PRODUCT-A00003', 'Madera de Roble', 'Madera de Roble', 2000, 2000, 2000, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (4, 'PRODUCT-A00004', 'Madera de Caoba', 'Madera de Caoba', 3000, 3000, 3000, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (5, 'PRODUCT-A00005', 'Madera de Nogal', 'Madera de Nogal', 4000, 4000, 4000, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (6, 'PRODUCT-A00006', 'Madera de Teca', 'Madera de Teca', 5000, 5000, 5000, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, code, name, description, price, priceUSD, priceEUR, stock, stock_min, status) VALUES (7, 'PRODUCT-A00007', 'Madera de Cerezo', 'Madera de Cerezo', 6000, 6000, 6000, 100, 10, 1);
